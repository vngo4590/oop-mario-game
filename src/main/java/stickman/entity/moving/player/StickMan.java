...
public class StickMan extends MovingObject implements Controllable {
    ...
    @Override
    public StickMan copy() {
        StickMan tempStickMan = new StickMan(xPos, yPos, "normal", null);
        tempStickMan.active = this.active;
        tempStickMan.xVelocity = this.xVelocity;
        tempStickMan.yVelocity = this.yVelocity;
        tempStickMan.leftFacing = this.leftFacing;
        tempStickMan.size = this.size;
        tempStickMan.upgraded = this.upgraded;
        tempStickMan.width = this.width;
        tempStickMan.height = this.height;
        tempStickMan.xPos = this.xPos;
        tempStickMan.yPos = this.yPos;
        tempStickMan.imagePath = this.imagePath;
        this.getObservers().forEach((tempStickMan::attach));
        return tempStickMan;
    }
